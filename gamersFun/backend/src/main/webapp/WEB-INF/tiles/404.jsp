    ...
    <div class="main-wrap">
        ...
        <main class="position-relative">
            ...
            <div class="main_content sidebar_right mt-100 mb-100">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6 col-md-12 d-lg-block d-none"><img src="assets/imgs/theme/fogg-page-not-found.png" alt=""></div>
                        <div class="col-lg-6 col-md-12">
                            ...
                            <p class="">The link you clicked may be broken or the page may have been removed.<br> visit the <a href="index.html">Homepage</a> or <a href="contact.html">Contact us</a> about the problem
                            </p>
