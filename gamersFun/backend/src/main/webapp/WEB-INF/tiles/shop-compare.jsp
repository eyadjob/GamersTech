...
<head>
    ...
    <title>Products Compare - UltraNews - Bootstrap 4 Magazine Template</title>
                ...
                <div class="container">
                    <div class="row align-items-center h-100">
                        <div class="col-md-6 mx-auto">
                            <h2><span class="color6">Products Compare </span></h2>
                        </div>
                        <div class="col-md-6 mx-auto text-center text-md-right">
                            <div class="breadcrumb">
                                <a href="index.html">Home</a><span></span>
                                <a href="shop-category.html">Pages</a><span></span> Compare
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="container">
                            ...
                            <div class="compare_box">
                                <div class="table-responsive">
                                    <table class="table table-bordered text-center">
                                        <tbody>
                                            <tr class="pr_image">
                                                <td class="text-muted font-medium font-weight-bold">Preview</td>
                                                <td class="row_img">
                                                    <img src="http://via.placeholder.com/600x600" alt="compare-img">
                                                </td>
                                                <td class="row_img"><img src="http://via.placeholder.com/600x600" alt="compare-img"></td>
                                                <td class="row_img"><img src="http://via.placeholder.com/600x600" alt="compare-img"></td>
                                            </tr>
                                            <tr class="pr_title">
                                                <td class="text-muted font-medium font-weight-bold">Name</td>
                                                <td class="product_name"><a href="shop-product-detail.html">J.Crew Mercantile Women's Short-Sleeve</a></td>
                                                <td class="product_name"><a href="shop-product-detail.html">Amazon Essentials Women's Tank</a></td>
                                                <td class="product_name"><a href="shop-product-detail.html">Amazon Brand - Daily Ritual Women's Jersey </a></td>
                                            </tr>
                                            <tr class="pr_price">
                                                <td class="text-muted font-medium font-weight-bold">Price</td>
                                            ...
                                            <tr class="pr_rating">
                                                <td class="text-muted font-medium font-weight-bold">Rating</td>
                                                <td>
                                            ...
                                            <tr class="pr_add_to_cart">
                                                <td class="text-muted font-medium font-weight-bold">Add To Cart</td>
                                                <td class="row_btn"><button class="btn btn-small d-inline"><i class="ti-shopping-cart mr-5"></i>Add to cart</button></td>
                                                <td class="row_btn"><button class="btn btn-small btn-dark d-inline"><i class="ti-headphone mr-5"></i>Contact Us</button></td>
                                                <td class="row_btn"><button class="btn btn-small d-inline"><i class="ti-shopping-cart mr-5"></i>Add to cart</button></td>
                                            </tr>
                                            <tr class="description">
                                                <td class="text-muted font-medium font-weight-bold">Description</td>
                                                <td class="row_text">
                                            ...
                                            <tr class="pr_color">
                                                <td class="text-muted font-medium font-weight-bold">Color</td>
                                                <td class="row_color">
                                            ...
                                            <tr class="pr_size">
                                                <td class="text-muted font-medium font-weight-bold">Sizes Available</td>
                                                <td class="row_size">
                                            ...
                                            <tr class="pr_stock">
                                                <td class="text-muted font-medium font-weight-bold">Stock status</td>
                                                <td class="row_stock"><span class="color3 font-weight-bold">In Stock</span></td>
                                                <td class="row_stock"><span class="color4 font-weight-bold">Out of stock</span></td>
                                                <td class="row_stock"><span class="color3 font-weight-bold">In Stock</span></td>
                                            </tr>
                                            <tr class="pr_weight">
                                                <td class="text-muted font-medium font-weight-bold">Weight</td>
                                                <td class="row_weight">320 gram</td>
                                                <td class="row_weight">370 gram</td>
                                                <td class="row_weight">380 gram</td>
                                            </tr>
                                            <tr class="pr_dimensions">
                                                <td class="text-muted font-medium font-weight-bold">Dimensions</td>
                                                <td class="row_dimensions">N/A</td>
                                                <td class="row_dimensions">N/A</td>
                                                <td class="row_dimensions">N/A</td>
                                            </tr>
                                            <tr class="pr_remove text-muted">
                                                <td class="text-muted font-medium font-weight-bold"></td>
                                                <td class="row_remove">
                                                    <a href="#"><span>Remove</span> <i class="ti-trash remove-icon"></i></a>
                                                </td>
                                                <td class="row_remove">
                                                    <a href="#"><span>Remove</span> <i class="ti-trash remove-icon"></i></a>
                                                </td>
                    ...
                    <div class="row">
                        <div class="container">
                            <div class="col-12">
                                <p class="text-center">
                                    <a href="https://themeforest.net/item/ultranews-magazine-bootstrap-4-template/26563121"><img class="d-inline" src="http://via.placeholder.com/728x90" alt=""></a>
                                </p>
                            </div>
                        </div>
                    </div>
