...
<head>
    ...
    <title>Shopping Cart - UltraNews - Bootstrap 4 Magazine Template</title>
        ...
        <main class="position-relative">
                ...
                <div class="container">
                    <div class="row align-items-center h-100">
                        <div class="col-md-6 mx-auto">
                            <h2><span class="color6">Shopping Cart</span></h2>
                        </div>
                        <div class="col-md-6 mx-auto text-center text-md-right">
                            <div class="breadcrumb">
                                <a href="index.html">Home</a><span></span>
                                <a href="shop-category.html">Pages</a><span></span> Shopping Cart
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="main_content shop shopping-cart pb-50">
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="table-responsive">
                                <table class="table shopping-summery shop_cart_table">
                                    <thead>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="image product-thumbnail"><img src="http://via.placeholder.com/600x600" alt="#"></td>
                                            <td class="product-des product-name">
                                                <p class="product-name"><a href="shop-product-detail-full.html">Blue Dress For Woman</a></p>
                                                <p class="product-des">Maboriosam in a tonto nesciung eget<br> distingy magndapibus.
                                                </p>
                                            </td>
                                            <td class="price" data-title="Price"><span>$55.00 </span></td>
                                        ...
                                        <tr>
                                            <td class="image"><img src="http://via.placeholder.com/600x600" alt="#"></td>
                                            <td class="product-des">
                                                <p class="product-name"><a href="shop-product-detail-full.html">Women T-shirt</a></p>
                                                <p class="product-des">Sit at ipsum amet clita no est,<br> sed amet sadipscing et gubergren</p>
                                            </td>
                                            <td class="price" data-title="Price"><span>$45.00 </span></td>
                                            <td class="qty" data-title="Qty">
                                                <!-- Input Order -->
                                                <div class="detail-qty border radius">
                                                    <a href="#" class="qty-down"><i class="fa fa-caret-down" aria-hidden="true"></i></a>
                                            ...
                                            <td class="total-amount" data-title="Total"><span>$45.00</span></td>
                                            <td class="action" data-title="Remove"><a href="#"><i class="ti-trash remove-icon"></i></a></td>
                                        </tr>
                                        <tr>
                                            <td class="image"><img src="http://via.placeholder.com/600x600" alt="#"></td>
                                            <td class="product-des">
                                                <p class="product-name"><a href="shop-product-detail-full.html">Woman full sliv dress</a></p>
                                                <p class="product-des">Erat amet et et amet diam et et.<br> Justo amet at dolore
                                                </p>
                                            </td>
                                            <td class="price" data-title="Price"><span>$85.00 </span></td>
                                            <td class="qty" data-title="Qty">
                                                <!-- Input Order -->
                                                <div class="detail-qty border radius">
                                                    <a href="#" class="qty-down"><i class="fa fa-caret-down" aria-hidden="true"></i></a>
                                            ...
                                            <td class="total-amount" data-title="Total"><span>$85.00</span></td>
                                            <td class="action" data-title="Remove"><a href="#"><i class="ti-trash remove-icon"></i></a></td>
                                        </tr>
                                    </tbody>
                                </table>
                    ...
                    <div class="divider center_icon mt-50 mb-50"><i class="ti-shopping-cart"></i></div>
                    <div class="row mb-50">
                        <div class="col-lg-6 col-md-12">
                            ...
                            <form class="field_form shipping_calculator">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-lg-12">
                                        <button class="btn btn-dark btn-fill-line" type="submit">Update Totals</button>
                                    </div>
                                </div>
                            </form>
                                    ...
                                    <table class="table">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="cart_total_amount">$240.00</td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="cart_total_amount"><strong>$240.00</strong></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
