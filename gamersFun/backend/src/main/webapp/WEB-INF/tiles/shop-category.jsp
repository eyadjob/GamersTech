...
<head>
    ...
    <title>Shop - UltraNews - Bootstrap 4 Magazine Template</title>
    ...
    <div class="main-wrap">
        ...
        <main class="position-relative">
            ...
            <div class="main-search-form transition-02s">
                <div class="container">
                    <div class="pb-50 main-search-form-cover pt-50">
                        <div class="row mb-20">
                            <div class="col-12">
            ...
            <!--archive header-->
            <div class="archive-header text-center shop-header pt-40 pb-40 mb-50">
                <div class="container">
                    <h2><span class="color4">Women Clothing</span></h2>
                    <div class="breadcrumb">
                        <a href="index.html" rel="nofollow">Home</a><span></span>
                        <a href="shop-category.html" rel="nofollow">Fashion</a><span></span>
                        <a href="shop-category.html" rel="nofollow">Women</a><span></span>
                        Clothing
                    </div>
                </div>
            </div>
            <!--main content-->
            <div class="main_content shop sidebar_right pb-50">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-9 col-md-12 col-sm-12">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="shop-top shop-fillter">
                                        <div class="shop-shorter">
                                            <div class="single-shorter">
                                                <label class="text-muted font-medium">Show</label>
                                                ...
                                                <div class="nice-select" tabindex="0"><span class="current">09</span>
                                                    <ul class="list">
                                                        <li data-value="09" class="option selected">09</li>
                                            ...
                                            <div class="single-shorter">
                                                <label class="text-muted font-medium ml-30">Sort</label>
                                                <div class="nice-select" tabindex="0"><span class="current">Name</span>
                                                    <ul class="list">
                                                        <li data-value="Name" class="option selected">Name</li>
                                                        <li data-value="Price" class="option">Price</li>
                                                        <li data-value="Size" class="option">Size</li>
                                                    </ul>
                                                </div>
                                            </div>
                                            <div class="single-shorter">
                                                <div class="nice-select" tabindex="0"><span class="current">ASC</span>
                                                    <ul class="list">
                                                        <li data-value="Name" class="option selected">ASC</li>
                                                        <li data-value="Price" class="option">DESC</li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="view-mode btn-group btn-list-grid float-right d-inline-block">
                                            <button type="button" id="list-view" class="btn-default list-view"><i class="ti-view-list"></i></button>
                                            <button type="button" id="grid-view" class="btn-default grid-view active"><i class="ti-layout-grid2"></i></button>
                                        </div>
                                    </div>
                                    <!--/ End Shop Top -->
                                </div>
                            ...
                            <!--Products-->
                            <div class="row mb-50 ">
                                <div class="product-layout product-grid col-lg-4 col-md-6 col-12">
                                    <div class="single-product">
                                        <div class="product-img border-radius-10">
                                            <a href="shop-product-detail.html">
                                                <img class="default-img" src="http://via.placeholder.com/1800x2300" alt="#">
                                                <img class="hover-img" src="http://via.placeholder.com/1800x2300" alt="#">
                                            ...
                                            <div class="button-head">
                                                ...
                                                <div class="product-action-2">
                                                    <a title="Add to cart" href="shop-cart.html">Add to cart</a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="product-content">
                                            <h6 class="product-title mb-5"><a href="shop-product-detail.html">Dead Men Womens T-Shirt</a></h6>
                                            ...
                                            <p class="product-desc mt_20 mb_60">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla in urna vel mi auctor tempus. Maecenas accumsan faucibus ligula ut facilisis. Nunc consequat elementum lobortis. Vestibulum volutpat velit sit amet eros consectetur tempus.</p>
                                            <div class="product-action">
                                                <a data-toggle="modal" data-target="#exampleModal" title="Quick View" href="#"><i class=" ti-eye"></i><span>Quick Shop</span></a>
                                                <a title="Wishlist" href="#"><i class=" ti-heart "></i><span>Add to Wishlist</span></a>
                                                <a title="Compare" href="#"><i class="ti-bar-chart-alt"></i><span>Add to Compare</span></a>
                                            ...
                                            <div class="product-action-2">
                                                <button type="button" class="btn btn-default list-view active">Add to cart</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="product-layout product-grid col-lg-4 col-md-6 col-12">
                                    <div class="single-product">
                                        ...
                                        <div class="product-content">
                                            <h6 class="product-title mb-5"><a href="shop-product-detail.html">Zoo Puzzle Kids T-Shirt</a></h6>
                                            <div class="product-rate">
                                                <div class="product-rating" style="width:70%"></div>
                                            </div>
                                            <div class="product-price">
                                                <span><strong>$34.00</strong></span>
                                            </div>
                                            <p class="product-desc mt_20 mb_60">Maecenas ultricies tristique lacus. Sed ut elementum dui. Ut ultricies facilisis purus, a tincidunt arcu maximus in. Nullam sem sem, scelerisque nec rutrum eu, auctor id lorem. Mauris posuere accumsan risus quis fermentum. In hac habitasse platea dictumst.</p>
                                            <div class="product-action">
                                                <a data-toggle="modal" data-target="#exampleModal" title="Quick View" href="#"><i class=" ti-eye"></i><span>Quick Shop</span></a>
                                                <a title="Wishlist" href="#"><i class=" ti-heart "></i><span>Add to Wishlist</span></a>
                                                <a title="Compare" href="#"><i class="ti-bar-chart-alt"></i><span>Add to Compare</span></a>
                                ...
                                <div class="product-layout product-grid col-lg-4 col-md-6 col-12">
                                    <div class="single-product">
                                        ...
                                        <div class="product-content">
                                            <h6 class="product-title mb-5"><a href="shop-product-detail.html">Women Hot Collection</a></h6>
                                            <div class="product-rate">
                                            ...
                                            <p class="product-desc mt_20 mb_60">Nullam gravida ex sed dui semper finibus. In ornare eu magna sit amet consectetur. Suspendisse sodales tortor justo, quis laoreet nisl eleifend ut. Mauris semper commodo arcu eget tristique.</p>
                                            <div class="product-action">
                                                <a data-toggle="modal" data-target="#exampleModal" title="Quick View" href="#"><i class=" ti-eye"></i><span>Quick Shop</span></a>
                                                <a title="Wishlist" href="#"><i class=" ti-heart "></i><span>Add to Wishlist</span></a>
                                                <a title="Compare" href="#"><i class="ti-bar-chart-alt"></i><span>Add to Compare</span></a>
                                ...
                                <div class="product-layout product-grid col-lg-4 col-md-6 col-12">
                                    <div class="single-product">
                                        ...
                                        <div class="product-content">
                                            <h6 class="product-title mb-5"><a href="shop-product-detail.html">New Aviator Sunglasses</a></h6>
                                            <div class="product-rate">
                                                <div class="product-rating" style="width:50%"></div>
                                            </div>
                                            <div class="product-price">
                                                <span><strong>$46.00</strong></span>
                                            </div>
                                            <p class="product-desc mt_20 mb_60">Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Fusce imperdiet lacus sit amet nibh pretium tincidunt. Cras mollis porta augue tristique gravida.</p>
                                            <div class="product-action">
                                                <a data-toggle="modal" data-target="#exampleModal" title="Quick View" href="#"><i class=" ti-eye"></i><span>Quick Shop</span></a>
                                                <a title="Wishlist" href="#"><i class=" ti-heart "></i><span>Add to Wishlist</span></a>
                                                <a title="Compare" href="#"><i class="ti-bar-chart-alt"></i><span>Add to Compare</span></a>
                                ...
                                <div class="product-layout product-grid col-lg-4 col-md-6 col-12">
                                    <div class="single-product">
                                        ...
                                        <div class="product-content">
                                            <h6 class="product-title mb-5"><a href="shop-product-detail.html">Chenille Cardigan </a></h6>
                                            <div class="product-rate">
                                                <div class="product-rating" style="width:80%"></div>
                                            </div>
                                            <div class="product-price">
                                            ...
                                            <p class="product-desc mt_20 mb_60">Duis dolor urna, dignissim sed leo eget, malesuada tincidunt nibh. Vestibulum at quam tincidunt, pharetra turpis mattis, condimentum nunc. Nullam at pharetra nisi. Cras eu dui est. Donec accumsan ligula purus.</p>
                                            <div class="product-action">
                                                <a data-toggle="modal" data-target="#exampleModal" title="Quick View" href="#"><i class=" ti-eye"></i><span>Quick Shop</span></a>
                                                <a title="Wishlist" href="#"><i class=" ti-heart "></i><span>Add to Wishlist</span></a>
                                                <a title="Compare" href="#"><i class="ti-bar-chart-alt"></i><span>Add to Compare</span></a>
                                ...
                                <div class="product-layout product-grid col-lg-4 col-md-6 col-12">
                                    <div class="single-product">
                                        ...
                                        <div class="product-content">
                                            <h6 class="product-title mb-5"><a href="shop-product-detail.html">Floral Embroidery </a></h6>
                                            <div class="product-rate">
                                                <div class="product-rating" style="width:90%"></div>
                                            </div>
                                            <div class="product-price">
                                                <span><strong>$129.00</strong></span>
                                            </div>
                                            <p class="product-desc mt_20 mb_60">Clita clita et sanctus sed sit clita amet, ut tempor et duo est nonumy. Lorem sadipscing stet sea sed sadipscing.Fountain any revellers if of yet, sick he from sight within. At gathered the a the he control it from.</p>
                                            <div class="product-action">
                                                <a data-toggle="modal" data-target="#exampleModal" title="Quick View" href="#"><i class=" ti-eye"></i><span>Quick Shop</span></a>
                                                <a title="Wishlist" href="#"><i class=" ti-heart "></i><span>Add to Wishlist</span></a>
                                                <a title="Compare" href="#"><i class="ti-bar-chart-alt"></i><span>Add to Compare</span></a>
                                ...
                                <div class="product-layout product-grid col-lg-4 col-md-6 col-12">
                                    <div class="single-product">
                                        ...
                                        <div class="product-content">
                                            <h6 class="product-title mb-5"><a href="shop-product-detail.html">Jacket Slogan</a></h6>
                                            <div class="product-rate">
                                                <div class="product-rating" style="width:100%"></div>
                                            </div>
                                            <div class="product-price">
                                                <span><strong>$76.00</strong></span>
                                            </div>
                                            <p class="product-desc mt_20 mb_60">Niuno noi una ancora vita novellare i. Viviamo nostro che cospetto benignita in uomini che sua. Esser in coloro cominciamento fatica pieno. Piene cosa che la e cosa suo da di nella, e come in facitore reputiamo per oportune il porgere lui, al occulta fatica.</p>
                                            <div class="product-action">
                                                <a data-toggle="modal" data-target="#exampleModal" title="Quick View" href="#"><i class=" ti-eye"></i><span>Quick Shop</span></a>
                                                <a title="Wishlist" href="#"><i class=" ti-heart "></i><span>Add to Wishlist</span></a>
                                                <a title="Compare" href="#"><i class="ti-bar-chart-alt"></i><span>Add to Compare</span></a>
                                ...
                                <div class="product-layout product-grid col-lg-4 col-md-6 col-12">
                                    <div class="single-product">
                                        ...
                                        <div class="product-content">
                                            ...
                                            <div class="product-price">
                                                <span><strong>$89.00</strong></span>
                                                <span class="old-price">$59.00</span>
                                            </div>
                                            <p class="product-desc mt_20 mb_60">Ea dolor ea sea clita ea justo, aliquyam duo ipsum voluptua duo dolore elitr kasd kasd. Justo lorem duo sea dolores ipsum sanctus tempor, et et rebum ea ea, amet vero amet aliquyam nonumy clita. At at eos vero kasd.</p>
                                            <div class="product-action">
                                                <a data-toggle="modal" data-target="#exampleModal" title="Quick View" href="#"><i class=" ti-eye"></i><span>Quick Shop</span></a>
                                                <a title="Wishlist" href="#"><i class=" ti-heart "></i><span>Add to Wishlist</span></a>
                                                <a title="Compare" href="#"><i class="ti-bar-chart-alt"></i><span>Add to Compare</span></a>
                                ...
                                <div class="product-layout product-grid col-lg-4 col-md-6 col-12">
                                    <div class="single-product">
                                        ...
                                        <div class="product-content">
                                            <h6 class="product-title mb-5"><a href="shop-product-detail.html"> Simple T-Shirt </a></h6>
                                            <div class="product-rate">
                                            ...
                                            <p class="product-desc mt_20 mb_60">Diam et kasd kasd elitr aliquyam. Stet dolore sadipscing voluptua vero labore aliquyam no stet. Invidunt nonumy consetetur kasd aliquyam. Takimata et et dolore lorem dolor ipsum elitr stet nonumy. Tempor ipsum dolore sed sed magna dolores sed, lorem sea diam ipsum.</p>
                                            <div class="product-action">
                                                <a data-toggle="modal" data-target="#exampleModal" title="Quick View" href="#"><i class=" ti-eye"></i><span>Quick Shop</span></a>
                                                <a title="Wishlist" href="#"><i class=" ti-heart "></i><span>Add to Wishlist</span></a>
                                                <a title="Compare" href="#"><i class="ti-bar-chart-alt"></i><span>Add to Compare</span></a>
                                ...
                                <div class="product-layout product-grid col-lg-4 col-md-6 col-12">
                                    <div class="single-product">
                                        ...
                                        <div class="product-content">
                                            <h6 class="product-title mb-5"><a href="shop-product-detail.html">Adidas Solar Glide</a></h6>
                                            <div class="product-rate">
                                                <div class="product-rating" style="width:90%"></div>
                                            </div>
                                            <div class="product-price">
                                                <span><strong>$27.00</strong></span>
                                            </div>
                                            <p class="product-desc mt_20 mb_60">At diam accusam at erat rebum eos ipsum lorem. Sed ea tempor diam voluptua accusam dolores dolore elitr. Elitr ea et labore et invidunt ipsum ut dolor dolores, dolor at et aliquyam takimata ipsum dolores gubergren ipsum, clita.</p>
                                            <div class="product-action">
                                                <a data-toggle="modal" data-target="#exampleModal" title="Quick View" href="#"><i class=" ti-eye"></i><span>Quick Shop</span></a>
                                                <a title="Wishlist" href="#"><i class=" ti-heart "></i><span>Add to Wishlist</span></a>
                                                <a title="Compare" href="#"><i class="ti-bar-chart-alt"></i><span>Add to Compare</span></a>
                                ...
                                <div class="product-layout product-grid col-lg-4 col-md-6 col-12">
                                    <div class="single-product">
                                        ...
                                        <div class="product-content">
                                            <h6 class="product-title mb-5"><a href="shop-product-detail.html">Flowers Dresses</a></h6>
                                            <div class="product-rate">
                                                <div class="product-rating" style="width:50%"></div>
                                            </div>
                                            <div class="product-price">
                                                <span><strong>$33.00</strong></span>
                                            </div>
                                            <p class="product-desc mt_20 mb_60">Gubergren sit rebum dolores vero invidunt sadipscing gubergren magna. Lorem et tempor erat est eos no, tempor lorem justo sed ut sanctus et. Lorem tempor nonumy amet voluptua, rebum lorem dolor duo lorem sanctus, ea.</p>
                                            <div class="product-action">
                                                <a data-toggle="modal" data-target="#exampleModal" title="Quick View" href="#"><i class=" ti-eye"></i><span>Quick Shop</span></a>
                                                <a title="Wishlist" href="#"><i class=" ti-heart "></i><span>Add to Wishlist</span></a>
                                                <a title="Compare" href="#"><i class="ti-bar-chart-alt"></i><span>Add to Compare</span></a>
                                ...
                                <div class="product-layout product-grid col-lg-4 col-md-6 col-12">
                                    <div class="single-product">
                                        ...
                                        <div class="product-content">
                                            <h6 class="product-title mb-5"><a href="shop-product-detail.html">Gathered Sleeve</a></h6>
                                            <div class="product-rate">
                                                <div class="product-rating" style="width:80%"></div>
                                            </div>
                                            <div class="product-price">
                                                <span><strong>$125.00</strong></span>
                                            </div>
                                            <p class="product-desc mt_20 mb_60">Junge schon so so wo ihr sanken glück, stund' immer schaust nacht mein werden ist deine ich im. Ich du wangen verschwand die und deiner, träume werden ihr mein beiden du die die nicht, was.</p>
                                            <div class="product-action">
                                                <a data-toggle="modal" data-target="#exampleModal" title="Quick View" href="#"><i class=" ti-eye"></i><span>Quick Shop</span></a>
                                                <a title="Wishlist" href="#"><i class=" ti-heart "></i><span>Add to Wishlist</span></a>
                                                <a title="Compare" href="#"><i class="ti-bar-chart-alt"></i><span>Add to Compare</span></a>
                            ...
                            <div class="widget-area">
                                ...
                                <div class="sidebar-widget widget_categories mb-50 p-30 bg-grey border-radius-10">
                                    ...
                                    <div class="">
                                        <ul class="categor-list">
                                            <li class="cat-item text-muted"><a href="shop-category.html">Jacket</a>(125)</li>
                                            <li class="cat-item text-muted"><a href="shop-category.html">Jeans</a>(68)</li>
                                            <li class="cat-item text-muted"><a href="shop-category.html">Sweatshirts</a>(284)</li>
                                            <li class="cat-item text-muted"><a href="shop-category.html">Trousers</a>(274)</li>
                                            <li class="cat-item text-muted"><a href="shop-category.html">Kitwears</a>(152)</li>
                                            <li class="cat-item text-muted"><a href="shop-category.html">Sportswear</a>(302)</li>
                                            <li class="cat-item text-muted"><a href="shop-category.html">Accessories</a>(168)</li>
                                        </ul>
                                    </div>
                                </div>
                                <!-- Fillter By Price -->
                                <div class="sidebar-widget price_range  range mb-50 p-30 bg-grey border-radius-10">
                                    <div class="widget-header position-relative mb-20 pb-10">
                                    ...
                                    <button type="button" class="btn btn-small">Refine Search</button>
                                </div>
                                ...
                                <div class="sidebar-widget product-sidebar  mb-50 p-30 bg-grey border-radius-10">
                                    ...
                                    <div class="single-post clearfix">
                                        <div class="image">
                                            <img src="http://via.placeholder.com/1800x2300" alt="#">
                                        </div>
                                        <div class="content">
                                            <h6><a href="shop-product-detail.html">Chen Cardigan</a></h6>
                                            <p class="price mb-0">$99.50</p>
                                            <div class="product-rate">
                                                <div class="product-rating" style="width:90%"></div>
                                            </div>
                                        </div>
                                ...
                                <div class="sidebar-widget widget-ads mb-30">
                                    <a href="http://via.placeholder.com/900x630" class="play-video" data-animate="zoomIn" data-duration="1.5s" data-delay="0.1s">
                                        <img class=" border-radius-10" src="http://via.placeholder.com/432x336" alt="">
                                    </a>
                                </div>
                                <!--Widget categories-->
                                <div class="sidebar-widget widget_categories mb-50 p-30 bg-grey border-radius-10">
                                    ...
                                    <div class="">
                                        <ul class="categor-list">
                                            <li class="cat-item text-muted"><a href="shop-category.html">Adidas</a>(125)</li>
                                            <li class="cat-item text-muted"><a href="shop-category.html">Armani</a>(68)</li>
                                            <li class="cat-item text-muted"><a href="shop-category.html">Burberry</a>(274)</li>
                                            <li class="cat-item text-muted"><a href="shop-category.html">Chanel</a>(152)</li>
                                            <li class="cat-item text-muted"><a href="shop-category.html">Prada</a>(302)</li>
                                            <li class="cat-item text-muted"><a href="shop-category.html">Hermes</a>(168)</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row d-flex align-items-center justify-content-between">
                            <div class="col-lg-6">
                                <div class="footer-copy-right">
                                    <p class="font-medium">© 2020, UltraNews | All rights reserved | Design by <a href="https://alithemes.com" target="_blank">AliThemes</a></p>
                                </div>
                            </div>
                            <div class="col-lg-6">
