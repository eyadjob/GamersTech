    ...
    <div class="main-wrap">
        ...
        <main class="position-relative">
            ...
            <div class="archive-header text-center">
                <div class="container">
                    <h2><span class="color1">Policy</span></h2>
                            ...
                            <div class="loop-big">
                                <article class="first-post mb-50 animate-conner">
                                    ...
                                    <div class="post-content">
                                        <div class="entry-meta meta-0 font-small mb-15">
                                            <a href="category.html"><span class="post-cat background5 color-white">Heal</span></a>
                                        </div>
                                        <h3 class="post-title">
                                ...
                                <article class="first-post mb-50 animate-conner">
                                    ...
                                    <div class="post-content">
                                        ...
                                        <div class="entry-meta meta-1 font-small color-grey mt-15 mb-15">
                                            <span class="post-by">By <a href="author.html">Helios</a></span>
                                ...
                                <article class="first-post mb-50 animate-conner">
                                    ...
                                    <div class="post-content">
                                        <div class="entry-meta meta-0 font-small mb-15">
                                            <a href="category.html"><span class="post-cat background2 color-white">sport</span></a>
                                        </div>
                                        <h3 class="post-title">
