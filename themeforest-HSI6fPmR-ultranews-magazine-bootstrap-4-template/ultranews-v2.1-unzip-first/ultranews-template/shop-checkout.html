...
<head>
    ...
    <title>Checkout - UltraNews - Bootstrap 4 Magazine Template</title>
            ...
            <div class="main_content shop shopping-cart pb-50">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="toggle_info">
                                <span><i class="ti-ticket mr-5"></i><span class="text-muted">Have a coupon?</span> <a href="#coupon" data-toggle="collapse" class="collapsed" aria-expanded="false">Click here to enter your code</a></span>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-25">
                                <h5><i class="ti-bookmark-alt mr-5 text-muted"></i> Billing Details</h5>
                            </div>
                            <form method="post">
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <div class="checkbox">
                                        <div class="custome-checkbox">
                                            ...
                                            <label class="form-check-label label_info" data-toggle="collapse" data-target="#collapsePassword" aria-controls="collapsePassword" for="createaccount"><span>Create an account?</span></label>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        <div class="chek-form">
                                            <div class="custome-checkbox">
                                                ...
                                                <label class="form-check-label label_info" data-toggle="collapse" data-target="#collapseAddress" aria-controls="collapseAddress" for="differentaddress"><span>Ship to a different address?</span></label>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="order_review">
                                <div class="mb-20">
                                    <h5><i class="ti-package mr-5 text-muted"></i> Your Orders</h5>
                                </div>
                                <div class="table-responsive order_table">
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td><i class="ti-check-box font-small text-muted mr-10"></i><a href="shop-product-detail.html">Yidarton Women Summer Blue</a> <span class="product-qty">x 2</span></td>
                                                <td>$180.00</td>
                                            </tr>
                                            <tr>
                                                <td><i class="ti-check-box font-small text-muted mr-10"></i><a href="shop-product-detail.html">LDB MOON Women Summe</a> <span class="product-qty">x 1</span></td>
                                                <td>$65.00</td>
                                            </tr>
                                            <tr>
                                                <td><i class="ti-check-box font-small text-muted mr-10"></i><a href="shop-product-detail.html">Women's Short Sleeve Loose</a> <span class="product-qty">x 1</span></td>
                                                <td>$35.00</td>
                                            </tr>
                                        </tbody>
                                        <tfoot>
                                            <tr>
                                                <th>SubTotal</th>
                                                <td class="product-subtotal">$280.00</td>
                                            </tr>
                                            <tr>
                                                <th>Shipping</th>
                                            ...
                                            <tr>
                                                <th>Total</th>
                                                <td class="product-subtotal"><strong>$280.00</strong></td>
                                            </tr>
                                        </tfoot>
                                    </table>
                                </div>
                                ...
                                <div class="payment_method">
                                    ...
                                    <div class="payment_option">
                                        <div class="custome-radio">
                                            ...
                                            <label class="form-check-label" for="exampleRadios3" data-toggle="collapse" data-target="#bankTranfer" aria-controls="bankTranfer">Direct Bank Transfer</label>
                                        ...
                                        <div class="custome-radio">
                                            ...
                                            <label class="form-check-label" for="exampleRadios4" data-toggle="collapse" data-target="#checkPayment" aria-controls="checkPayment">Check Payment</label>
                                        ...
                                        <div class="custome-radio">
                                            ...
                                            <label class="form-check-label" for="exampleRadios5" data-toggle="collapse" data-target="#paypal" aria-controls="paypal">Paypal</label>
