...
<head>
    ...
    <title>Product Single - UltraNews - Bootstrap 4 Magazine Template</title>
                ...
                <div class="container">
                    <div class="row align-items-center h-100">
                        <div class="col-md-6 mx-auto">
                            <h2><span class="color6">Women T-shirt</span></h2>
                        </div>
                        <div class="col-md-6 mx-auto text-right">
                            <div class="breadcrumb">
                                ...
                                <a href="shop-category.html" rel="nofollow">Women</a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="product-detail accordion-detail">
                                ...
                                <div class="row">
                                    ...
                                    <div class="product-layout product-grid col-lg-3 col-md-6 col-12">
                                        <div class="single-product mt-0">
                                            ...
                                            <div class="product-content">
                                                <h6 class="product-title mb-5"><a href="shop-product-detail.html">Dead
                                                        Men Womens T-Shirt</a></h6>
                                                ...
                                                <div class="product-action-2">
                                                    <button type="button" class="btn btn-default list-view active">Add
                                                        to cart</button>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="product-layout product-grid col-lg-3 col-md-6 col-12">
                                        <div class="single-product mt-0">
                                            ...
                                            <div class="product-content">
                                                <h6 class="product-title mb-5"><a href="shop-product-detail.html">Zoo
                                                        Puzzle Kids T-Shirt</a></h6>
                                                <div class="product-rate">
                                    ...
                                    <div class="product-layout product-grid col-lg-3 col-md-6 col-12">
                                        <div class="single-product mt-0">
                                            ...
                                            <div class="product-content">
                                                <h6 class="product-title mb-5"><a href="shop-product-detail.html">Women
                                                        Hot Collection</a></h6>
                                                <div class="product-rate">
