            ...
            <div class="main_content sidebar_right pb-50">
                <div class="single-header-2 row no-gutters mb-50 background12">
                    <div class="col-lg-6 col-md-12">
                        <figure class="single-thumnail img-hover-slide mb-0" style="background-image: url(http://via.placeholder.com/1920x887)"></figure>
                        <span class="top-right-icon background8"><i class="mdi mdi-favorite"></i></span>
                    </div>
                    <div class="col-lg-6 col-md-12">
                        <div class="entry-header entry-header-1">
                            <div class="entry-meta meta-0 font-small mb-30"><a href="category.html"><span class="post-cat background2 color-white">Technology</span></a></div>
                            <h1 class="post-title">
                    ...
                    <div class="row">
                        <div class="col-lg-8 col-md-12 col-sm-12">
                            ...
                            <div class="entry-main-content">
                                ...
                                <figure class="wp-block-gallery columns-3">
                                    <ul class="blocks-gallery-grid">
                                        <li class="blocks-gallery-item">
                                            <a href="#"><img class="border-radius-5" src="http://via.placeholder.com/500x500" alt=""></a>
                                        </li>
                                        <li class="blocks-gallery-item">
                                            <a href="#"><img class="border-radius-5" src="http://via.placeholder.com/500x500" alt=""></a>
                                        </li>
                                ...
                                <p class="text-center">
                                    <a href="#"><img class="d-inline" src="http://via.placeholder.com/728x90" alt=""></a>
                                </p>
                            </div>
