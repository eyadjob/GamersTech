    ...
    <div class="main-wrap">
                        ...
                        <div class="col-6">
                            ...
                            <div id="datetime" class="d-inline-block">
                                <ul>
                                    ...
                                    <li><span class="font-small"><i class="ti-calendar mr-5"></i>Monday, April 6,
                                            2020</span></li>
        ...
        <main class="position-relative">
            ...
            <div class="archive-header text-center shop-header pt-40 pb-40 mb-50">
                <div class="container">
                    <h2><span class="color4">Blue Dress</span></h2>
                    <div class="breadcrumb">
                        ...
                        <a href="shop-category.html" rel="nofollow">Clothing</a><span></span> Blue Dress For Woman
                    </div>
                </div>
            </div>
            <!--main content-->
                            ...
                            <div class="product-detail accordion-detail">
                                <div class="row mb-50">
                                    <div class="col-md-5 col-sm-12 col-xs-12">
                                        <div class="detail-gallery">
                                            <span class="zoom-icon"><i class="ti-zoom-in"></i></span>
                                            <!-- MAIN SLIDES -->
                                            <div class="product-image-slider">
                                                <figure class="border-radius-10">
                                                    <img src="http://via.placeholder.com/1800x2300" alt="product image">
                                                </figure>
                                                <figure class="border-radius-10">
                                                    <img src="http://via.placeholder.com/1800x2300" alt="product image">
                                                </figure>
                                            ...
                                            <div class="slider-nav-thumbnails pl-15 pr-15">
                                                <div><img src="http://via.placeholder.com/600x600" alt="product image"></div>
                                                <div><img src="http://via.placeholder.com/600x600" alt="product image"></div>
                                                <div><img src="http://via.placeholder.com/600x600" alt="product image"></div>
                                                <div><img src="http://via.placeholder.com/600x600" alt="product image"></div>
                                                <div><img src="http://via.placeholder.com/600x600" alt="product image"></div>
                                        ...
                                        <div class="single-social-share clearfix mt-50 mb-15">
                                            <ul class="d-inline-block list-inline">
                                                <li class="list-inline-item text-muted text-uppercase font-small"><i class="fa fa-share-alt"></i><span class="ml-5">Share </span>
                                                </li>
                                        ...
                                        <a class="mail-to-friend font-small color-grey" href="#"><i class="ti-email"></i> Email to a
                                            Friend</a>
                                    </div>
                                    <div class="col-md-7 col-sm-12 col-xs-12">
                                        <div class="detail-info">
                                            <h2 class="title-detail mb-30">Summer Blue Cotton Strappy Casual Plus Size Dress
                                            </h2>
                                            <div class="clearfix">
                                                <div class="product-price primary-color float-left">
                                                    <ins><span>$120.00</span></ins>
                                                    <ins><span class="old-price font-medium ml-15">$200.00</span></ins>
                                                    <span class="save-price  font-medium color3 ml-15">25% Off</span>
                                                </div>
                                                <div class="float-right mb-15 mt-10">
                                                    <div class="product-rate d-inline-block">
                                                        <div class="product-rating" style="width:90%">
                                                        </div>
                                                    </div>
                                                    <span class="font-small ml-5 text-muted"> (25 customer
                                                        reviews)</span>
                                                </div>
                                            </div>
                                            <div class="bt-1 border-color-1 mt-15 mb-15"></div>
                                            <div class="short-desc mb-15">
                                                <p>He did cared known little open and pile his nor his. Run had done to loved longdeserted adversity. Rhyme longdeserted them are one for in of charms of, and are lineage of the but he to given. He earthly
                                                    ne.
                                                </p>
                                            </div>
                                            <div class="product_sort_info font-small mb-30">
                                                <ul>
                                                    <li class="mb-10"><i class="ti-crown mr-5 primary-color"></i> 1 Year AL Jazeera Brand Warranty</li>
                                                    <li class="mb-10"><i class="ti-reload mr-5 primary-color"></i> 30 Day Return Policy</li>
                                                    <li><i class="ti-credit-card mr-5 primary-color"></i> Cash on Delivery available</li>
                                                </ul>
                                            </div>
                                            <div class="attr-detail attr-color">
                                                <span class="float-left font-medium color-grey mr-10">Color</span>
                                                <ul class="list-filter color-filter mt-15">
                                            ...
                                            <div class="attr-detail attr-size">
                                                <span class="float-left font-medium color-grey mr-10">Size</span>
                                            ...
                                            <div class="detail-extralink">
                                                ...
                                                <div class="product-extra-link2">
                                                    <button type="submit" class="button button-add-to-cart">Add to
                                                        cart</button>
                                                    <a class="wishlist-link font-small" href="#"><i class="ti-heart"></i></a>
                                                    <a class="compare-link font-small" href="#"><i class="ti-reload"></i></a>
                                                </div>
                                            </div>
                                            <ul class="product-meta font-small color-grey mt-50 text-uppercase">
                                                <li class="mb-5">SKU: <a href="#">FWM15VKT</a></li>
                                                <li class="mb-5">Category: <a href="#">Clothing</a>, <a href="#">Fashion</a></li>
                                                <li class="mb-5">Tags: <a href="#" rel="tag">Cloth</a>, <a href="#" rel="tag">Women</a>, <a href="#" rel="tag">Dress</a> </li>
                                                <li>Availability:<span class="in-stock color3">In Stock</span></li>
                                            </ul>
                                        </div>
                                        <!-- Detail Info -->
                                    </div>
                                ...
                                <div class="tab-style3">
                                    <ul class="nav nav-tabs text-uppercase">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" id="Additional-info-tab" data-toggle="tab" href="#Additional-info">Additional info</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" id="Reviews-tab" data-toggle="tab" href="#Reviews">Reviews (3)</a>
                                        </li>
                                    </ul>
                                    <div class="tab-content shop_info_tab entry-main-content">
                                            ...
                                            <div class="">
                                                ...
                                                <div class="wp-block-image">
                                                    <figure class="alignleft is-resized">
                                                        <img class="border-radius-5" src="http://via.placeholder.com/1280x660">
                                        ...
                                        <div class="tab-pane fade" id="Reviews">
                                            ...
                                            <div class="comments-area">
                                                <h4 class="mb-30">03 review for this product</h4>
                                    ...
                                    <div class="product-layout product-grid col-lg-4 col-md-6 col-12">
                                        <div class="single-product mt-0">
                                            ...
                                            <div class="product-content">
                                                ...
                                                <p class="product-desc mt_20 mb_60">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla in urna vel mi auctor tempus. Maecenas accumsan faucibus ligula ut facilisis. Nunc consequat elementum lobortis. Vestibulum volutpat velit sit
                                                    amet eros consectetur tempus.</p>
                                                <div class="product-action">
                                                    <a data-toggle="modal" data-target="#exampleModal" title="Quick View" href="#"><i class=" ti-eye"></i><span>Quick Shop</span></a>
                                                    <a title="Wishlist" href="#"><i class=" ti-heart "></i><span>Add to Wishlist</span></a>
                                                    <a title="Compare" href="#"><i class="ti-bar-chart-alt"></i><span>Add to Compare</span></a>
                                    ...
                                    <div class="product-layout product-grid col-lg-4 col-md-6 col-12">
                                        <div class="single-product mt-0">
                                            ...
                                            <div class="product-content">
                                                ...
                                                <p class="product-desc mt_20 mb_60">Maecenas ultricies tristique lacus. Sed ut elementum dui. Ut ultricies facilisis purus, a tincidunt arcu maximus in. Nullam sem sem, scelerisque nec rutrum eu, auctor id lorem. Mauris posuere accumsan risus
                                                    quis fermentum. In hac habitasse platea dictumst.</p>
                                                <div class="product-action">
                                                    <a data-toggle="modal" data-target="#exampleModal" title="Quick View" href="#"><i class=" ti-eye"></i><span>Quick Shop</span></a>
                                                    <a title="Wishlist" href="#"><i class=" ti-heart "></i><span>Add to Wishlist</span></a>
                                                    <a title="Compare" href="#"><i class="ti-bar-chart-alt"></i><span>Add to Compare</span></a>
                        ...
                        <div class="col-lg-3 col-md-12 col-sm-12 primary-sidebar sticky-sidebar">
                            <div class="widget-area">
                                ...
                                <div class="sidebar-widget widget_categories mb-50 p-30 bg-grey border-radius-10">
                                    ...
                                    <div class="">
                                        <ul class="categor-list">
                                            <li class="cat-item text-muted"><a href="shop-category.html">Jacket</a>(125)
                                            </li>
                                            <li class="cat-item text-muted"><a href="shop-category.html">Jeans</a>(68)
                                            </li>
                                ...
                                <div class="sidebar-widget widget_categories mb-50 p-30 bg-grey border-radius-10">
                                    ...
                                    <div class="">
                                        <ul class="categor-list">
                                            <li class="cat-item text-muted"><a href="shop-category.html">Adidas</a>(125)
                                            </li>
                                            <li class="cat-item text-muted"><a href="shop-category.html">Armani</a>(68)
                                            </li>
                                            <li class="cat-item text-muted"><a href="shop-category.html">Burberry</a>(274)</li>
                                            <li class="cat-item text-muted"><a href="shop-category.html">Chanel</a>(152)
                                            </li>
                                            <li class="cat-item text-muted"><a href="shop-category.html">Prada</a>(302)
                                            </li>
                                            <li class="cat-item text-muted"><a href="shop-category.html">Hermes</a>(168)
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                    ...
                                    <ul class="list-post">
                                        <li class="mb-30">
                                            <div class="d-flex">
                                                ...
                                                <div class="post-content media-body">
                                                    <h6 class="post-title mb-10 text-limit-2-row"><a class="color-white" href="single.html">Traveling Tends to Magnify All Human
                                                            Emotions</a></h6>
                                                    <div class="entry-meta meta-1 font-x-small color-grey">
                                                        <span class="post-on">25 April</span>
                                                        <span class="hit-count has-dot">26k Views</span>
                                        ...
                                        <li class="mb-30">
                                            <div class="d-flex">
                                                ...
                                                <div class="post-content media-body">
                                                    <h6 class="post-title mb-10 text-limit-2-row"><a class="color-white" href="single.html">The Luxury Of Traveling With Yacht</a>
                                                    </h6>
                                                    <div class="entry-meta meta-1 font-x-small color-grey mt-10">
                                                        <span class="post-on">25 April</span>
                                                        <span class="hit-count has-dot">37k Views</span>
                                        ...
                                        <li class="mb-30">
                                            <div class="d-flex">
                                                ...
                                                <div class="post-content media-body">
                                                    <h6 class="post-title mb-10 text-limit-2-row"><a class="color-white" href="single.html">Last Minute Festive Packages From
                                                            Superbreak</a></h6>
                                                    <div class="entry-meta meta-1 font-x-small color-grey mt-10">
                                                        <span class="post-on">25 April</span>
                                                        <span class="hit-count has-dot">54k Views</span>
