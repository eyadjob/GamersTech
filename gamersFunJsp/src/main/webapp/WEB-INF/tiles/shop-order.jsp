...
<head>
    ...
    <title>Order Completed - UltraNews - Bootstrap 4 Magazine Template</title>
                    ...
                    <div class="row justify-content-center mb-100 mt-100">
                        <div class="col-md-8">
                            <div class="text-center order_complete">
                                <img src="assets/imgs/theme/complete.png" alt="" class="d-inline mb-30">
                                <h2 class="mb-30">Your order is completed!</h2>
                                <h5 class="mb-30 text-muted">Order SN: JDK112243958</h5>
                                <p class="mb-30">Thank you for your order! Your order is being processed and will be completed within 2-4 hours. You will receive an email confirmation when your order is completed.</p>
                                <a href="shop-category.html" class="btn btn-fill-out text-white"><i class="ti-shopping-cart mr-5"></i>Continue Shopping</a>
                            </div>
                        </div>
                    </div>
                </div>
