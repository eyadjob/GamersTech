        ...
        <main class="position-relative">
            ...
            <div class="archive-header text-center mb-50 mt-20">
                <div class="container">
                    ...
                    <h1><span class="color2">Hello</span></h1>
                    <p class="font-small color-grey">We found 22 articles for you. </p>
                </div>
            </div>
            <!--main content-->
                                ...
                                <div class="loop-list">
                                    <article class="first-post mb-50 animate-conner">
                                        ...
                                        <div class="post-content">
                                            <div class="entry-meta meta-0 font-small mb-15">
                                                <a href="category.html"><span class="post-cat background1 color-white">Global</span></a>
                                            </div>
                                            <h3 class="post-title">
                                                <a href="single.html">Essential Qualities of Highly Successful Music</a>
                                            </h3>
                                            <div class="entry-meta meta-1 font-small color-grey mt-15 mb-15">
                                                <span class="post-by">By <a href="author.html">Jonh</a></span>
                                    ...
                                    <div class="loop-grid row">
                                        ...
                                        <article class="col-lg-6 mb-50 animate-conner">
                                            ...
                                            <div class="post-content">
                                                <div class="entry-meta meta-0 font-small mb-15">
                                                    <a href="category.html"><span class="post-cat background2 color-white">Fashion</span></a>
                                                </div>
                                                <h3 class="post-title">
                                                    <a href="single.html">The World Caters to Average People</a>
                                                </h3>
                                                <div class="entry-meta meta-1 font-small color-grey mt-15 mb-15">
                                                    <span class="post-by">By <a href="author.html">Helen</a></span>
                                                ...
                                                <div class="post-excerpt mb-25">
                                                    <p>These people envy me for having a lifestyle they don’t have, but the truth is, sometimes I envy their lifestyle instead. Struggling to sell one multi-million dollar home currently.</p>
                                                </div>
                                            </div>
                                        </article>
                                        <article class="col-lg-6 mb-50 animate-conner">
                                            ...
                                            <div class="post-content">
                                                <div class="entry-meta meta-0 font-small mb-15">
                                                    <a href="category.html"><span class="post-cat background3 color-white">Technology</span></a>
                                                </div>
                                                <h3 class="post-title">
                                                ...
                                                <div class="post-excerpt mb-25">
                                                    <p>We live in a world where disruption and dynamism reign supreme and businesses must be ready to adapt to the many unpredictable changes that come with this.</p>
                                                </div>
                                            </div>
                                        </article>
                                        <article class="col-lg-6 mb-50 animate-conner">
                                            ...
                                            <div class="post-content">
                                                <div class="entry-meta meta-0 font-small mb-15">
                                                    <a href="category.html"><span class="post-cat background1 color-white">Sport</span></a>
                                                </div>
                                                <h3 class="post-title">
                                                    <a href="single.html">9 Things I Love About Shaving My Head</a>
                                                </h3>
                                                <div class="entry-meta meta-1 font-small color-grey mt-15 mb-15">
                                                    <span class="post-by">By <a href="author.html">Donal</a></span>
                                                    <span class="post-on"><i class="ti-marker-alt"></i>25 April 2020</span>
                                                    <span class="time-reading"><i class="ti-timer"></i>10 mins read</span>
                                                    <span class="hit-count"><i class="ti-bolt"></i> 159k Views</span>
                                                </div>
                                                <div class="post-excerpt mb-25">
                                                    <p>At the Emmys, broadcast scripted shows created by people of color gained ground relative to those pitched by White show creators, while broadcast scripted shows.</p>
                                                </div>
                                            </div>
                                        </article>
                                        <article class="col-lg-6 mb-50 animate-conner">
