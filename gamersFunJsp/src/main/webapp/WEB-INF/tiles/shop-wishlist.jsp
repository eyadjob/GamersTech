...
<head>
    ...
    <title>Wishlist - UltraNews - Bootstrap 4 Magazine Template</title>
                ...
                <div class="container">
                    <div class="row align-items-center h-100">
                        <div class="col-md-6 mx-auto">
                            <h2><span class="color6">Wishlist</span></h2>
                        </div>
                        <div class="col-md-6 mx-auto text-center text-md-right">
                            <div class="breadcrumb">
                                <a href="index.html">Home</a><span></span>
                                <a href="shop-category.html">Pages</a><span></span> Wishlist
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="product-des product-name">
                                                <p class="product-name"><a href="shop-product-detail-full.html">J.Crew Mercantile Women's Short-Sleeve</a></p>
                                            ...
                                            <td class="text-right" data-title="Cart">
                                                <button class="btn btn-small"><i class="ti-shopping-cart mr-5"></i>Add to cart</button>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="product-des">
                                                <p class="product-name"><a href="shop-product-detail-full.html">Amazon Essentials Women's Tank</a></p>
                                        ...
                                        <tr>
                                            <td class="image"><img src="http://via.placeholder.com/600x600" alt="#"></td>
                                            <td class="product-des">
                                                <p class="product-name"><a href="shop-product-detail-full.html">Amazon Brand - Daily Ritual Women's Jersey </a></p>
                                            ...
                                            <td class="text-center" data-title="Stock">
                                                <span class="color4 font-weight-bold">Out of stock</span>
                                            </td>
                                            <td class="text-right" data-title="Cart">
                                                <button class="btn btn-small btn-dark"><i class="ti-headphone  mr-5"></i>Contact Us</button>
                                            </td>
                                            <td class="action" data-title="Remove"><a href="#"><i class="ti-trash remove-icon"></i></a></td>
                                        </tr>
                                    </tbody>
