...
<head>
    ...
    <link rel="stylesheet" th:href="@{/assets/css/widgets.css}"  href="../../assets/css/widgets.css">
    <link rel="stylesheet" th:href="@{/assets/css/color.css}"  href="../../assets/css/color.css">
...
<body class="page-contact">
                            ...
                            <div class="col-6">
                                ...
                                <div id="datetime" class="d-inline-block">
                                    <ul>
                                        ...
                                        <li><a class="color-white" href="#"><span class="font-small"><i class="ti-book mr-5"></i>Read Today’s Paper</span></a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-4 col-sm-12">
                            ...
                            <p>If you would like to partner with Ultra at our next event, contact us at contact@ultranews.com.</p>
                        </div>
                        <div class="col-md-4 col-sm-12">
                        ...
                        <div class="col-md-4 col-sm-12">
                            ...
                            <p>Please send request details to email event@ultranews.com</p>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-12"><img src="assets/imgs/theme/marginalia-productive-work.png" alt=""></div>
                    </div>
                </div>
            </div>
        </main>
    ...
    <!-- Vendor JS-->
    <script href="../../assets/js/vendor/modernizr-3.6.0.min.js" th:src="@{/assets/js/vendor/modernizr-3.6.0.min.js}"></script>
    <script href="../../assets/js/vendor/jquery-3.6.0.min.js" th:src="@{/assets/js/vendor/jquery-3.6.0.min.js}"></script>
    <script href="../../assets/js/vendor/popper.min.js" th:src="@{/assets/js/vendor/popper.min.js}"></script>
    <script href="../../assets/js/vendor/bootstrap.min.js" th:src="@{/assets/js/vendor/bootstrap.min.js}"></script>
    <script href="../../assets/js/vendor/jquery.slicknav.js" th:src="@{/assets/js/vendor/jquery.slicknav.js}"></script>
    <script href="../../assets/js/vendor/owl.carousel.min.js" th:src="@{/assets/js/vendor/owl.carousel.min.js}"></script>
    <script href="../../assets/js/vendor/slick.min.js" th:src="@{/assets/js/vendor/slick.min.js}"></script>
    <script href="../../assets/js/vendor/wow.min.js" th:src="@{/assets/js/vendor/wow.min.js}"></script>
    <script href="../../assets/js/vendor/animated.headline.js" th:src="@{/assets/js/vendor/animated.headline.js}"></script>
    <script href="../../assets/js/vendor/jquery.magnific-popup.js" th:src="@{/assets/js/vendor/jquery.magnific-popup.js}"></script>
    <script href="../../assets/js/vendor/jquery.ticker.js" th:src="@{/assets/js/vendor/jquery.ticker.js}"></script>
    <script href="../../assets/js/vendor/jquery.vticker-min.js" th:src="@{/assets/js/vendor/jquery.vticker-min.js}"></script>
    <script href="../../assets/js/vendor/jquery.scrollUp.min.js" th:src="@{/assets/js/vendor/jquery.scrollUp.min.js}"></script>
    <script href="../../assets/js/vendor/jquery.nice-select.min.js" th:src="@{/assets/js/vendor/jquery.nice-select.min.js}"></script>
    <script href="../../assets/js/vendor/jquery.sticky.js" th:src="@{/assets/js/vendor/jquery.sticky.js}"></script>
    <script href="../../assets/js/vendor/perfect-scrollbar.js" th:src="@{/assets/js/vendor/perfect-scrollbar.js}"></script>
    <script href="../../assets/js/vendor/waypoints.min.js" th:src="@{/assets/js/vendor/waypoints.min.js}"></script>
    <script href="../../assets/js/vendor/jquery.counterup.min.js" th:src="@{/assets/js/vendor/jquery.counterup.min.js}"></script>
    <script href="../../assets/js/vendor/jquery.theia.sticky.js" th:src="@{/assets/js/vendor/jquery.theia.sticky.js}"></script>
    <!-- UltraNews JS -->
    <script href="../../assets/js/main.js"  th:src="@{/assets/js/main.js}"></script>
</body>
